module.exports.defineElement = function(elementName, ipcRenderer){
  ...
  class MineSweeper extends HTMLElement {
    ...
    createBoard(){
      requestAnimationFrame(
        () => ((ipcRenderer) ? ipcRenderer.send('resize-to-content', JSON.stringify({x: this.clientWidth, y: this.clientHeight})) : undefined)
      );
    ...
    connectedCallback(){
      ...
      if(ipcRenderer) ipcRenderer.on('resize-to-content-reply', (event, arg) => {
  ...
  customElements.define(elementName, MineSweeper);
}
